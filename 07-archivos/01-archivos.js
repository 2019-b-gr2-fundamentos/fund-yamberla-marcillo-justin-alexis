...
var _02_leer_archivo_1 = require("./02-leer_archivo");
var prompts = require("prompts"); //para ingresar datos (necesario hacer funcion asincrona)
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var contador, contenidoArchivo, arregloCargadoDeArchivo, arregloEstudiantes, arregloPreguntas, respuestaEstudianteUno, nuevoRegistroUno, respuestaEstudianteDos, nuevoRegistroDos, idBuscar, indiceEncontrado, nombreEditar, buscar, estudianteEcontrado;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    buscar = _a.sent();
                    estudianteEcontrado = arregloEstudiantes.find(function (valorActual) {
